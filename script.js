...
function playAll(songNumber){
    ...
    if(audioElement.getAttribute("src")==songFileName && !audioElement.paused){
        audioElement.pause();
        playBtn.innerHTML='<img src="https://www.freepnglogos.com/uploads/play-button-png/play-button-blank-blank-and-pbs-animated-interviews-10.png">';
        ...
        audioElement.play();
        playBtn.innerHTML='<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Eo_circle_red_pause.svg/1200px-Eo_circle_red_pause.svg.png">';
